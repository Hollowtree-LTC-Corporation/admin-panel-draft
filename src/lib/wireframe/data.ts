...
export const ORGS = [
  { id: "org_1", name: "Acme Widgets Co", product: "DI", situs_state: "TX", enrollment_status: "active", individuals_count: 12, policy_owner_type: "employer", type_of_rate: "STD+LTD" },
  { id: "org_2", name: "Bluefin Logistics", product: "DI", situs_state: "CA", enrollment_status: "active", individuals_count: 7, policy_owner_type: "employer", type_of_rate: "LTD" },
  { id: "org_3", name: "Coastal Credit Union", product: "LTC", situs_state: "FL", enrollment_status: "active", individuals_count: 9, policy_owner_type: "individual", type_of_rate: null },
  { id: "org_4", name: "Delta Manufacturing", product: "DI", situs_state: "OH", enrollment_status: "closed", individuals_count: 4, policy_owner_type: "employer", type_of_rate: "LTD" },
  { id: "org_5", name: "Evergreen Health", product: "LTC", situs_state: "NY", enrollment_status: "active", individuals_count: 6, policy_owner_type: "individual", type_of_rate: null },
  { id: "org_6", name: "Foxtail Education Trust", product: "LTC", situs_state: "WA", enrollment_status: "pending", individuals_count: 2, policy_owner_type: "individual", type_of_rate: null },
  { id: "org_7", name: "Greylock Partners LLC", product: "DI", situs_state: "MA", enrollment_status: "active", individuals_count: 5, policy_owner_type: "employer", type_of_rate: "STD+LTD" },
  { id: "org_8", name: "Harborline Shipping", product: "DI", situs_state: "WA", enrollment_status: "active", individuals_count: 8, policy_owner_type: "employer", type_of_rate: "LTD" },
];
